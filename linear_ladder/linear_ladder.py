...
from .linear_encoder import LINEARStackedEncoders
from .linear_decoder import LINEARStackedDecoders


class LINEARLadder(torch.nn.Module):
    def __init__(self, n_classes, encoder_sizes, decoder_sizes,
        ...
        self.se = LINEARStackedEncoders(encoder_in, encoder_sizes, encoder_activations,
                                        encoder_train_bn_scalings, noise_std, use_cuda)
        self.de = LINEARStackedDecoders(decoder_in, decoder_sizes, encoder_in, use_cuda)
